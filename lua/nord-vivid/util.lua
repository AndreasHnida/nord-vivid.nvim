local util = {}
local nord = require("nord-vivid.theme")
...
function util.onColorScheme()
	if vim.g.colors_name ~= "nord-vivid" then
		vim.cmd([[autocmd! nord-vivid]])
		vim.cmd([[augroup! nord-vivid]])
	end
end
...
util.contrast = function()
	vim.cmd([[augroup nord-vivid]])
	vim.cmd([[  autocmd!]])
	vim.cmd([[  autocmd ColorScheme * lua require("nord-vivid.util").onColorScheme()]])
